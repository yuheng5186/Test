...
- (void)showItems{
    ...
    CGFloat r = 180;
    CGPoint point1 = CGPointMake(center.x - 100, center.y+r*sin(M_PI/24)+(30*Main_Screen_Height/667));

    CGPoint point3 = CGPointMake(center.x - 100, center.y - r*sin(M_PI / 4-M_PI/12)+(30*Main_Screen_Height/667));

    CGPoint point5 = CGPointMake(center.x-r*sin(M_PI/24), center.y - r+10+(30*Main_Screen_Height/667));
    
  
    UIView * view1 = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    view1.center = center;
    view1.userInteractionEnabled = YES;
    UITapGestureRecognizer * tap1 = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tap1)];
    UIImageView * imageVIew=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    imageVIew.image=[UIImage imageNamed:@"ershouche"];
    [view1 addSubview:imageVIew];
    [view1 addGestureRecognizer:tap1];
    UILabel * titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, view1.frame.size.height-(10*Main_Screen_Height/667), 80*Main_Screen_Height/667, 20*Main_Screen_Height/667)];
    titleLabel.text = @"二手车";
...
//    [menu1 addTarget:self action:@selector(_addExamApprovel:) forControlEvents:UIControlEventTouchUpInside];
    UIView * view3 = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    ...
    UIImageView * imageVIew1=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    imageVIew1.image=[UIImage imageNamed:@"dongtai"];
    [view3 addSubview:imageVIew1];
    [view3 addGestureRecognizer:tap3];
    UILabel * titleLabel1 = [[UILabel alloc]initWithFrame:CGRectMake(0, view3.frame.size.height-(10*Main_Screen_Height/667), 80*Main_Screen_Height/667, 20*Main_Screen_Height/667)];
    titleLabel1.text = @"动态";
    titleLabel1.font =[UIFont systemFontOfSize:15.0*Main_Screen_Height/667];
...
//    [menu3 addTarget:self action:@selector(_addExamApprovel:) forControlEvents:UIControlEventTouchUpInside];
    ...
    UIView * view5 = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    ...
    UIImageView * imageVIew2=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 80*Main_Screen_Height/667, 80*Main_Screen_Height/667)];
    imageVIew2.image=[UIImage imageNamed:@"tiwen"];
    [view5 addSubview:imageVIew2];
    UILabel * titleLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(0, view5.frame.size.height-(10*Main_Screen_Height/667), 80*Main_Screen_Height/667, 20*Main_Screen_Height/667)];
    titleLabel2.text = @"提问";
    titleLabel2.font =[UIFont systemFontOfSize:15.0*Main_Screen_Height/667];
