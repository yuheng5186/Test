...
@interface DiscountCategoryView ()
...
@implementation DiscountCategoryView
...
- (void)setupSingleLine {
    ...
    [singleLine mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(5*Main_Screen_Height/667);
    }];
}
