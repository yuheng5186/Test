...
- (void)setupUI {
    ...
    rangeOneLab.text = @"1、蔷薇积分仅可在蔷薇APP使用,如该账号暂停使用,则蔷薇将取消该用户账号内积分使用相关权限";
    ...
    rangeTwoLab.text = @"2、蔷薇积分可用于在蔷薇洗车APP中会员商城中兑换抵扣卷、洗车优惠券等活动";
    ...
    rangeThreeLab.text = @"3、积分查询: 您可以在我的-蔷薇会员中查询到您的积分详细情况";
    ...
    usefulOneLab.text = @"1、用户获得积分但未使用,将在下一个自然年份过期,蔷薇将定期对过期积分进行作废处理";
