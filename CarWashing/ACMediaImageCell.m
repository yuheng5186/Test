...
//    [_deleteButton setBackgroundImage:[UIImage imageForResourcePath:@"ACMediaFrame.bundle/deleteButton" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
    [_deleteButton setBackgroundImage:[UIImage imageNamed:@"shanchutupian"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    _deleteButton.frame = CGRectMake(self.bounds.size.width - ACMediaDeleteButtonWidth-10, 10, ACMediaDeleteButtonWidth, ACMediaDeleteButtonWidth);
