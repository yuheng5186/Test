...
- (void)viewDidLoad {
    ...
    containView.frame = CGRectMake(0, Main_Screen_Height, Main_Screen_Width, 300);
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    //更改视图
    self.containView.frame = CGRectMake(0, Main_Screen_Height - 300, Main_Screen_Width, 300);
...
- (void)clickDissmissButton{
    ...
    //更改视图
    self.containView.frame = CGRectMake(0, Main_Screen_Height, Main_Screen_Width, 300);
