...
- (void)drawNavigation {
    ...
    [self drawTitle:@"修改手机号" Color:[UIColor blackColor]];
...
//        self.phoneNumberText.placeholder    = @"输入验证码";
        self.phoneNumberText.text           = @"15800781856";
        ...
        self.phoneNumberText.left           = Main_Screen_Width*90/375 ;
        ...
        getVeriifyStrButton.layer.cornerRadius = 5;
        getVeriifyStrButton.left           = self.phoneNumberText.right +Main_Screen_Width*10/375;
        getVeriifyStrButton.centerY        = self.phoneNumberText.centerY;
    }else if (indexPath.row == 1){
        self.verifyNumberFieldText                = [[UITextField alloc]initWithFrame:CGRectMake(10, 45, Main_Screen_Width-150, 40)];
        ...
        self.verifyNumberFieldText.left           = Main_Screen_Width*90/375 ;
