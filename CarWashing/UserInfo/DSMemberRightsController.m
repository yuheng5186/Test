...
//    
    ...
    allScoreNameLabel.top               = SliderView .bottom +Main_Screen_Height*5/667;
    allScoreNameLabel.right             = SliderView .right;
    ...
    scoreRemindNameLabel.centerX           = SliderView .centerX;
